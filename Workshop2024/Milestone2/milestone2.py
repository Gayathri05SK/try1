...
class calculator:
    ...
    def ref_die_vec(self):
        return [(self.center[0]+self.die_vector[0] - self.die_height/2)  , (self.center[1]+self.die_vector[1] - (self.die_width/2)) ]
...
obj = calculator("F:\KLA workshop\Workshop2024\Milestone2\Input\Testcase1.txt")
